...
export class TaskResolver {
  ...
  @Query(() => TaskType)
  async findOneTask(@Args('id', ParseIntPipe) id: number): Promise<Task | GraphQLError> {
  ...
  @Mutation(() => Boolean)
  async deleteTask(@Args('id', ParseIntPipe) id: number): Promise<boolean | GraphQLError> {
